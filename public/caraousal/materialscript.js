(function () {
  ...
  function ge(t) {
    ...
    const d = i > r ? "next" : "prev",
      ...
      f = () => {
        ...
        let h = r + p * (i - r);
        if ((c(h, i) && (h = i), e.wrapperEl.scrollTo({ [s]: h }), c(h, i))) {
  ...
  function _e() {
    ...
    const V =
      ...
      Object.keys(i.breakpoints).filter(
        (m) => typeof i.breakpoints[m].slidesPerView < "u"
      ).length > 0;
    for (let m = 0; m < f; m += 1) {
      O = 0;
      let S;
    ...
    if (
      ((t.virtualSize = Math.max(t.virtualSize, r) + y),
      l &&
        o &&
        (i.effect === "slide" || i.effect === "coverflow") &&
        (s.style.width = `${t.virtualSize + w}px`),
      i.setWrapperSize &&
        (s.style[t.getDirectionLabel("width")] = `${t.virtualSize + w}px`),
    ...
    if (a && i.loop) {
      ...
      if (i.slidesPerGroup > 1) {
        ...
        for (let x = 0; x < S; x += 1) u.push(u[u.length - 1] + E);
      }
  ...
  function Re(t) {
    ...
    for (let a = 0; a < s.length; a += 1) {
      ...
      const f =
          (l + (i.centeredSlides ? e.minTranslate() : 0) - c) /
          (d.swiperSlideSize + o),
        u =
          (l - r[0] + (i.centeredSlides ? e.minTranslate() : 0) - c) /
          (d.swiperSlideSize + o),
        p = -(l - c),
  ...
  function He() {
    ...
    a &&
      ...
      l
        ...
        : ((c = Ie(a, `.${i.slideClass}, swiper-slide`)[0]),
          i.loop && !c && (c = e[0]),
          c && c.classList.add(i.slideNextClass),
    ...
    if (
      ...
      if (e === 0) o[f ? "scrollLeft" : "scrollTop"] = -c;
        ...
        if (!r.support.smoothScroll)
          return (
            ge({ swiper: r, targetPosition: -c, side: f ? "left" : "top" }), !0
          );
  ...
  var st = { setTransition: et, transitionStart: tt, transitionEnd: it };
  function rt(t, e, i, s, n) {
    ...
    if (
      ...
      return !1;
    l !== (c || 0) && i && r.emit("beforeSlideChangeStart"), r.updateProgress(v);
    let M;
    if (
    ...
    if (o.cssMode) {
      ...
      if (e === 0) {
        ...
        if (!r.support.smoothScroll)
          return (
            ge({ swiper: r, targetPosition: T, side: w ? "left" : "top" }), !0
          );
        p.scrollTo({ [w ? "left" : "top"]: T, behavior: "smooth" });
      }
      return !0;
    }
    return (
      ...
      (r = parseInt(t.clickedSlide.getAttribute("data-swiper-slide-index"), 10)),
        e.centeredSlides
          ? n < t.loopedSlides - s / 2 ||
            ...
            ? (t.loopFix(),
              (n = t.getSlideIndex(
                _(i, `${l}[data-swiper-slide-index="${r}"]`)[0]
              )),
              re(() => {
                t.slideTo(n);
              }))
  ...
  function pt(t) {
    ...
    const m = M ? Math.ceil(d.length / p.grid.rows) : d.length,
      E = (M ? d[r].column : r) + (h && typeof n > "u" ? -g / 2 + 0.5 : 0);
    if (E < v) {
      O = Math.max(v - E, y);
  ...
  var ht = { loopCreate: ut, loopFix: pt, loopDestroy: mt };
  function gt(t) {
    const e = this;
    if (
  ...
  var wt = { setGrabCursor: gt, unsetGrabCursor: vt };
  function St(t, e) {
    e === void 0 && (e = this);
    function i(s) {
      if (!s || s === $() || s === D()) return null;
  ...
  function xt(t) {
    ...
    if (a.type === "touchmove") {
      if (
        ((d = [...a.changedTouches].filter((L) => L.identifier === s.touchId)[0]),
    ...
    n.oneWayMovement &&
      ((h = Math.abs(h) * (l ? 1 : -1)), (g = Math.abs(g) * (l ? 1 : -1))),
      (r.diff = h),
      (h *= n.touchRatio),
      l && ((h = -h), (g = -g));
    ...
    if (!s.isMoved) {
      if (
        (v && M && i.loopFix({ direction: i.swipeDirection }),
          ...
          s.currentTranslate > i.minTranslate() &&
            ...
            n.resistance &&
              (s.currentTranslate =
                i.minTranslate() -
                1 +
                (-i.minTranslate() + s.startTranslate + h) ** b)))
        : h < 0 &&
          (v &&
            M &&
            !w &&
          ...
          s.currentTranslate < i.maxTranslate() &&
            ...
            n.resistance &&
              (s.currentTranslate =
                i.maxTranslate() +
                1 -
                (i.maxTranslate() - s.startTranslate - h) ** b))),
  ...
  function yt(t) {
    ...
    for (
      ...
      typeof d[b + L] < "u"
        ? (h || (p >= d[b] && p < d[b + L])) && ((g = b), (y = d[b + L] - d[b]))
        : (h || p >= d[b]) && ((g = b), (y = d[d.length - 1] - d[d.length - 2]));
    }
    let v = null,
      M = null;
    l.rewind &&
      ...
      e.swipeDirection === "next" &&
        ...
        e.swipeDirection === "prev" &&
          (w > 1 - l.longSwipesRatio
            ? e.slideTo(g + T)
            : M !== null && w < 0 && Math.abs(w) > l.longSwipesRatio
            ? e.slideTo(M)
            : e.slideTo(g));
    } else {
      if (!l.shortSwipes) {
  ...
  const Se = (t, e) => {
    const i = $(),
      ...
      d = e;
    i[a]("touchstart", t.onDocumentTouchStart, { passive: !1, capture: o }),
      n[a]("touchstart", t.onTouchStart, { passive: !1 }),
      n[a]("pointerdown", t.onTouchStart, { passive: !1 }),
      i[a]("touchmove", t.onTouchMove, { passive: !1, capture: o }),
      i[a]("pointermove", t.onTouchMove, { passive: !1, capture: o }),
  ...
  var Lt = { attachEvents: It, detachEvents: Ct };
    ...
    d && !c
      ...
      ["navigation", "pagination", "scrollbar"].forEach((v) => {
        ...
        const M = s[v] && s[v].enabled,
          w = a[v] && a[v].enabled;
        M && !w && t[v].disable(), !M && w && t[v].enable();
      });
  ...
  var At = { setBreakpoint: Ot, getBreakpoint: zt };
  function Gt(t, e) {
    const i = [];
    return (
      t.forEach((s) => {
  ...
  var Dt = { addClasses: Vt, removeClasses: kt };
  function Ft() {
    const t = this,
  ...
  class F {
    constructor() {
      ...
      (o.__swiper__ = !0),
        (o.support = ve()),
        (o.device = ze({ userAgent: i.userAgent })),
        (o.browser = Ge()),
        (o.eventsListeners = {}),
    ...
    slidesPerViewDynamic(e, i) {
      ...
      if (n.centeredSlides) {
        ...
        for (let p = d + 1; p < r.length; p += 1)
          r[p] &&
            !u &&
            ((f += r[p].swiperSlideSize), (c += 1), f > a && (u = !0));
    ...
    mount(e) {
      ...
      return (
        ...
        Object.assign(i, {
          ...
          wrapperEl: l,
          slidesEl:
            i.isElement && !s.parentNode.host.slideSlots ? s.parentNode.host : l,
    ...
    static use(e) {
      return Array.isArray(e)
        ? (e.forEach((i) => F.installModule(i)), F)
        : (F.installModule(e), F);
    }
  }
  ...
  function $t({ swiper: t, on: e, extendParams: i }) {
    i({ materialEffect: { slideSplitRatio: 0.65 } });
    const s = () => {
        ...
        for (let M = 0; M < r.length; M += 1) {
          ...
          if (P <= 0)
            if (u && d > 1) {
              if (
                (P <= 0 && P >= -(C - 2) && ((S = V), (m = 1), (E = 1)),
                H && P < -(C - Math.ceil(C / 2)))
              ) {
                const A = Math.ceil(C / 2) - Math.abs(P);
                (m = A), (E = m ** 4), (S = V + x * (1 - A) * (1 + I * 2));
              }
              if (B && P < -(C / 2 - 1) && P >= -(C / 2)) {
            ...
            } else (m = 1 + P), (S = -O), (E = m ** 4);
          if (d === 1)
            P > 0 && ((m = 1 - P), (S = -O + a * Math.min(P, 1)), (E = m ** 4));
          else {
            if (
              (P > 0 && P <= d - 2 && ((S = V), (m = 1), (E = 1)),
          ...
          m < 0 && (m = 0),
            ...
            t.isHorizontal()
              ? ((T.style.width = `${100 * m}%`),
                (T.style.transform = `translate3d(${S - G}px, 0, 0)`))
              : ((T.style.height = `${100 * m}%`),
      ...
      n = (r) => {
        ...
        Rt({ swiper: t, duration: r, transformElements: o, allSlides: !0 });
      };
    e("beforeInit", () => {
      ...
      t.classNames.push(`${t.params.containerModifierClass}material`),
        t.isElement &&
          t.hostEl &&
          t.hostEl.classList.add(`swiper-${t.params.direction}`);
      const r = {
